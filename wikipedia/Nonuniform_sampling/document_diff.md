# Document diff — Nonuniform sampling
*Sentence-level diff, original English → after the KPR merge. 39 lines added/changed.*

```diff
--- Nonuniform_sampling (original English)
+++ Nonuniform_sampling (after KPR merge)
@@ -17,33 +17,18 @@
